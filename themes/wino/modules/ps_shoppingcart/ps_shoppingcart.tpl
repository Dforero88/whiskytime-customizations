      ...
      <div class="blockcart-inner">
        ...
        {/if}
          ...
          <div class="shopping-desc">
           ...
           <!--  <span class="cart-product-value">{$cart.totals.total.value}</span> -->
          </div>
        {if $cart.products_count > 0}
          </a>
        {/if}
    ...
    {if $cart.products_count > 0}
            <div class="ax_cart cart-hover-content  dropdown-menu">
                ...
                <div class="cart-wishlist-action">
                    <a rel="nofollow" class="cart-wishlist-viewcart btn btn-primary" href="{$cart_url}">{l s='my cart' d='Shop.Theme.Checkout'}</a>
