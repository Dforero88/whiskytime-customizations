...
{block name='product_miniature_item'}
 <article class="{if isset($smarty.cookies.show_list)}product_show_list {/if}product-miniature js-product-miniature" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}">
					...
					<div class="product-add">
						  <form action="{$urls.pages.cart}" method="post" class="add-to-cart-or-refresh">
							...
							<button class="btn btn-primary add-to-cart" data-button-action="add-to-cart" type="submit" {if $product.availability == 'unavailable'}disabled{/if} title="{l s='Add to cart' d='Shop.Theme.Actions'}">						
								...
								<span class="aei-product-cart aei-product-tooltip">{l s='Add to cart' d='Shop.Theme.Actions'}</span>
							</button>
						</form>
						{block name='quick_view'}
							<a class="quick-view" href="#" data-link-action="quickview" title="{l s='Quick View' d='Shop.Theme.Actions'}">
								{l s='Quick view' d='Shop.Theme.Actions'}
								<span class="aei-product-quickview aei-product-tooltip">{l s='Quick View' d='Shop.Theme.Actions'}</span>
							</a>
						{/block}
					</div>
				{/if}
    ...
    <div class="product-description">
		...
		{block name='product_description_short'}
        	<div class="product-detail">{$product.description_short nofilter}</div>
        {/block}
