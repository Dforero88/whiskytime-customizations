...
<div class="block card card-block wtgiftcards-page">
    <style>
    ...
    <div class="gift_products_wrapper col-lg-12">
        {if count($giftProducts) > 0}
            ...
            <section id="products" class="giftcards-catalog push-down">
                <div id="js-product-list" class="wtcatalog-list">
                    <div class="products row filtr-container wtcatalog-grid">
                        {foreach from=$giftProducts item=$gift}
                            <article
                                class="product-miniature js-product-miniature filtr-item giftcard-miniature wtcatalog-card"
                            ...
                            >
                                <div class="thumbnail-container wtcatalog-card__inner">
                                    <a class="wtcatalog-card__overlay" href="{$gift.link|escape:'htmlall':'UTF-8'}" aria-label="{$gift.name|escape:'html':'UTF-8'}"></a>
