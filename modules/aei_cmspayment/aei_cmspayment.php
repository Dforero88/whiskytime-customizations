...
<li class="discover icon"><a href="#"><img src="https://demoprestashop.aeipix.com/AX03/wino49/modules/aei_cmspayment/views/img/p1.png" alt="" /></a></li>
<li class="master icon"><a href="#"><img src="https://demoprestashop.aeipix.com/AX03/wino49/modules/aei_cmspayment/views/img/p2.png" alt="" /></a></li>
<li class="visa icon"><a href="#"><img src="https://demoprestashop.aeipix.com/AX03/wino49/modules/aei_cmspayment/views/img/p3.png" alt="" /></a></li>
<li class="paypal icon"><a href="#"><img src="https://demoprestashop.aeipix.com/AX03/wino49/modules/aei_cmspayment/views/img/p4.png" alt="" /></a></li>
<li class="maestro icon"><a href="#"><img src="https://demoprestashop.aeipix.com/AX03/wino49/modules/aei_cmspayment/views/img/p5.png" alt="" /></a></li>
</ul>',
            ],
        ];
