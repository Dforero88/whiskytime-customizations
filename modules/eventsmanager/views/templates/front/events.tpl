...
{assign var=params value=['show'=> 'calendar']}
{$calendar_link = $link->getModuleLink('eventsmanager', 'calendar', $params)}
{capture name=path}<a href="{$link->getModuleLink('eventsmanager', 'events')|escape:'htmlall':'UTF-8'}">{l s='Events' mod='eventsmanager'}</a> | <a href="{$calendar_link}">{l s='Calendar' mod='eventsmanager'}</a>{/capture}
        ...
        <div class="sort_by total_events"> <p>{l s='Total Events: ' mod='eventsmanager'}{$nbEvents|escape:'htmlall':'UTF-8'} </p>  </div>
         ...
         <div class="sort_by"><label class="sorter-label" for="sorter">Sort By</label>
          <select id="sorter" data-role="sorter" class="sorter-options">
              ...
              <option onclick="fmmSortListDate();" id="sortdate" value="event_end_date">
                 Date            
              </option>
              <option onclick="fmmSortListName();" id="sortname" value="event_name">
                Event Name            
              </option>
          </select>
        </div>
