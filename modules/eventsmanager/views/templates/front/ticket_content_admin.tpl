		...
		<td colspan="12">
			...
			<table id="summary-tab" width="100%">
				<tr>
					...
					<th class="header small" valign="middle">{l s='Customer Phone'  mod='eventsmanager'}</th>
				...
				<tr>
					<td class="center small white">{$customer_name|escape:'htmlall':'UTF-8'}</td>
					<td class="center small white">{$customer_phone|escape:'htmlall':'UTF-8'}</td>
					<td class="center small white"></td>
					<td class="center small white">{dateFormat date=$booking_date|escape:'htmlall':'UTF-8' full=0}</td>
				</tr>
			</table>
		...
		<table class="product" width="100%" cellpadding="4" cellspacing="0">
			...
			<thead>
				<tr>
					...
					<th class="product header small" width="20%">{l s='Per Ticket'  mod='eventsmanager'}</th>
					<th class="product header small" width="20%">{l s='Qty'  mod='eventsmanager'}</th>
				</tr>
			</thead>
			...
			<tbody>
				<!-- PRODUCTS -->
					...
					<tr class="product {$bgcolor_class|escape:'htmlall':'UTF-8'}">
						...
						<td class="product center">
							{Product::getPriceStatic($id_product|escape:'htmlall':'UTF-8')}
						</td>
						
						<td class="product center">
							{$quantity|escape:'htmlall':'UTF-8'}
						</td>
		...
		<td colspan="7" class="left">
			...
			<table id="payment-tab" width="100%" cellpadding="4" cellspacing="0">
				<tr>
					...
					<td class="payment center small grey bold" width="44%">{l s='Reserve Seats'  mod='eventsmanager'}</td>
					<td class="payment left white" width="56%">
						<table width="100%" border="0">
							
								<tr>
									<td class="center large" style="color: green;">{$reserve_seats|escape:'htmlall':'UTF-8'}</td>
								</tr>
			...
			<table id="payment-tab" width="100%" cellpadding="4" cellspacing="0">
				<tr>
					...
					<td class="payment left white" width="56%">
						<table width="100%" border="0">
								<tr>
									<td class="small center">{l s='Awaiting'  mod='eventsmanager'}</td>
								</tr>
						</table>
					</td>
				</tr>
			...
			<table id="payment-tab" width="100%" cellpadding="4" cellspacing="0">
				<tr>
					...
					<td class="payment left white" width="56%">
						<table width="100%" border="0">
							<tr>
									<td class="center small">{l s='Backoffice Admin'  mod='eventsmanager'}</td>
							</tr>
						</table>
					</td>
				</tr>
