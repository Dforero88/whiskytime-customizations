            ...
            <div class="row">
              ...
              <div class="mat_event_content col-sm-10 clearfix" {if $version < 1.6} style="float: right; width: 65%;"{/if}>
                ...
                <div class="mat_event_date">
                  ...
                  {l s='From' mod='eventsmanager'} : <strong>{$_event.event_start_date|date_format:"%A %e %B %Y"|capitalize:true|escape:'htmlall':'UTF-8'}{if $events_timestamp > 0} {l s='at' mod='eventsmanager'} {$_event.event_start_date|date_format:"%H:%M"|escape:'htmlall':'UTF-8'}{/if}</strong>
                </div>
                <div class="mat_event_date">
                  <i class="icon-calendar"></i>
                  {l s='To' mod='eventsmanager'} : <strong>{$_event.event_end_date|date_format:"%A %e %B %Y"|capitalize:true|escape:'htmlall':'UTF-8'}{if $events_timestamp > 0} {l s='at' mod='eventsmanager'} {$_event.event_end_date|date_format:"%H:%M"|escape:'htmlall':'UTF-8'}{/if}</strong>
                </div>
