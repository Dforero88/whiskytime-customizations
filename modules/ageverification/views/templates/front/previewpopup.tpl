...
<script>
    ...
    var kbfronthome_url = '{$kbfront_url nofilter}';{*Variable contains a URL, escape not required*}
    ...
    var kb_valid_customer_message = "{l s='For Valid Date of Birth/Year Customers will be redirected to the Site.' mod='ageverification'}";
</script>
